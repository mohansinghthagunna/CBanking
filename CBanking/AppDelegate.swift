...
var responseData = NSMutableData()
    ...
    func requestURL(strURL: String) {
        // Create the request.
        let request: NSURLRequest = NSURLRequest(URL: NSURL(string:"http://creatudevelopers.com.np/C_banking/showall.php")!)
    ...
    func connectionDidFinishLoading(connection: NSURLConnection) {
        ...
        let a: String = String(data: responseData, encoding: NSASCIIStringEncoding)!
        print(a)
    }
